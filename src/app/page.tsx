...
import NavMenu from '@/components/global/navbar';
                ...
                <section className="mt-[-10px] w-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-gray-100 p-8 rounded-lg shadow-md relative">
                            ...
                            <ul>
                                <li>
                                    <Link href="/sign-up" className="relative inline-flex h-10 overflow-hidden rounded-full p-[2px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-white">
